...
const httpsOptions = {
  key: fs.readFileSync(path.join(__dirname, 'certs', 'key.pem')), // Ruta a tu archivo .key
  cert: fs.readFileSync(path.join(__dirname, 'certs', 'cert.pem')) // Ruta a tu archivo .pem
};
